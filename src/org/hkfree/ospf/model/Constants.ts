...
export namespace Constants {
     ...
     * @enum
     * @property {Constants.LANGUAGE} en_EN
     * @property {Constants.LANGUAGE} cs_CZ
     * @class
     */
     ...
     * @enum
     * @property {Constants.MODE} SHOW_NEIGHBORS
     * @property {Constants.MODE} COST_CHANGING
     * @property {Constants.MODE} SHORTEST_PATH
     * @property {Constants.MODE} GPS
     * @property {Constants.MODE} GPS_ALL
     * @property {Constants.MODE} ZOOM
     * @property {Constants.MODE} LOCK_ALL
     * @property {Constants.MODE} LOCK_VERTEX
     * @property {Constants.MODE} PICKING
     * @property {Constants.MODE} TRANSFORMING
     * @property {Constants.MODE} ADD_VERTEXES
     * @property {Constants.MODE} ADD_EDGES
     * @property {Constants.MODE} ASYMETRIC_LINKS
     * @property {Constants.MODE} SHORTEST_PATH_TWO_ROUTERS
     * @property {Constants.MODE} IPV6
     * @property {Constants.MODE} NONE
     * @class
     */
    export enum MODE {
     ...
     * Výčet tvarů spoje
     * @enum
     * @property {Constants.EDGE_SHAPER} QUAD_CURVE
     * @property {Constants.EDGE_SHAPER} LINE
     * @property {Constants.EDGE_SHAPER} BENT_LINE
     * @property {Constants.EDGE_SHAPER} CUBIC_CURVE
     * @class
     */
